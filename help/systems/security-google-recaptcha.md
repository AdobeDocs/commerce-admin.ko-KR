...
[Google reCAPTCHA](https://developers.google.com/recaptcha)에서는 컴퓨터(또는 &quot;보트&quot;)가 아닌 사람이 웹 사이트와 상호 작용하고 있는지 확인합니다. 표준 Adobe Commerce 및 Magento Open Source [CAPTCHA](security-captcha.md)와 달리 Google reCAPTCHA는 다양한 표시 옵션 및 메서드를 선택하여 향상된 보안을 제공합니다. 추가 웹 사이트 트래픽 정보는 Google reCAPTCHA 계정의 대시보드에서 사용할 수 있습니다.
