...
1. 클릭 **[!UICONTROL Submit]** 를 눌러 선택한 각 인덱서에 변경 사항을 적용합니다.
   ...
   **인덱스 관리 열**
   ...
   | [!UICONTROL Status] | 다음 중 하나를 표시합니다. <br/>**[!UICONTROL Ready]**— 색인이 최신 버전입니다.<br/>**[!UICONTROL Suspended]** - 리인덱싱이 일시 중지되었습니다. <br/>**[!UICONTROL Processing]**- 리인덱싱이 현재 실행 중입니다.<br/>**[!UICONTROL Reindex Required]** - 리인덱싱이 필요하지만 인덱서를 자동으로 업데이트할 수 없도록 변경되었습니다. 다음을 확인하십시오. [cron](cron.md) 을 사용할 수 있으며 올바로 구성하십시오. |
