...
1. 선택한 각 인덱서에 변경 내용을 적용하려면 **[!UICONTROL Submit]**&#x200B;을(를) 클릭하십시오.
   ...
   **인덱스 관리 열**
   ...
   | [!UICONTROL Status] | 다음 중 하나를 표시합니다. <br/>**[!UICONTROL Ready]**— 색인이 최신 상태입니다.<br/>**[!UICONTROL Suspended]** - 리인덱싱이 일시 중지되었습니다. <br/>**[!UICONTROL Processing]**- 리인덱싱이 현재 실행 중입니다.<br/>**[!UICONTROL Reindex Required]** - 인덱싱을 다시 지정해야 하지만 인덱서를 자동으로 업데이트할 수 없습니다. [cron](cron.md)을(를) 사용할 수 있고 올바르게 구성되어 있는지 확인하십시오. |
