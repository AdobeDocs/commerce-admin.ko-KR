...
* [Adobe Commerce 커넥터](https://experienceleague.adobe.com/en/docs/commerce/aco-optimizer-connector/overview)로 구성된 클라우드 또는 온-프레미스 배포의 경우 Commerce Optimizer Studio에서 [데이터 동기화 페이지](https://experienceleague.adobe.com/en/docs/commerce/optimizer/setup/data-sync)를 확인하세요.

>[!TIP]
>
>데이터 동기화 프로세스에 대한 자세한 내용은 *SaaS 데이터 내보내기 안내서*&#x200B;에서 [SaaS 데이터 내보내기와 데이터 동기화](https://experienceleague.adobe.com/en/docs/commerce/saas-data-export/data-synchronization)를 참조하십시오.
...
>[!NOTE]
>
>[[!DNL Adobe Commerce as a Cloud Service]](https://experienceleague.adobe.com/en/docs/commerce/cloud-service/overview) 인스턴스에 데이터 피드 상태 확장을 설치할 필요가 없습니다.
...
>[!MORELIKETHIS]
>
>* [데이터 관리 대시보드](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard)
