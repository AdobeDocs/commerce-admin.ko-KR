...
>[!VIDEO](https://video.tv.adobe.com/v/3443514?captions=kor&quality=12&learn=on)
...
|  | `Sales Channel` | [`Amazon Sales Channel`](https://experienceleague.adobe.com/ko/docs/discontinued/using/commerce-channels) |
...
|  | `System Insights` ![Adobe Commerce](../assets/adobe-logo.svg) | [`Site-Wide Analysis Tool`](https://experienceleague.adobe.com/ko/docs/commerce-operations/tools/site-wide-analysis-tool/access) |
