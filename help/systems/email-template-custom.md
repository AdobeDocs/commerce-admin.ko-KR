...
[구성](email-templates.md#configure-email-templates)을 완료한 후 전자 메일 헤더 템플릿에 스토어에 연결된 로고가 포함됩니다. HTML에 대한 기본 지식이 있는 경우 [사전 정의된 변수](variables-predefined.md)를 사용하여 저장소 연락처 정보를 헤더에 쉽게 추가할 수 있습니다.
