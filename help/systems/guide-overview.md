...
| [데이터 전송](data-transfer.md) | <ul><li>가져오기 및 내보내기 도구를 사용하면 한 번의 작업으로 여러 레코드를 관리할 수 있습니다. 새 항목을 가져올 수 있을 뿐만 아니라 기존 제품 세트를 업데이트, 대체 및 삭제할 수도 있습니다.</li><li>[[!UICONTROL Data Management Dashboard]](data-dashboard.md)에서 Commerce SaaS 서비스에 게시된 제품 데이터를 봅니다.</li><li>[[!UICONTROL Data Feed Sync Status]](data-feed-sync-status.md) 페이지에서 Commerce SaaS 서비스 데이터베이스로 데이터 내보내기 피드 동기화를 모니터링합니다.</li></ul> |
