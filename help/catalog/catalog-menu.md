...
[!UICONTROL Catalog] 메뉴를 통해 제품 만들기, 범주 및 재고 관리 도구, [B2B 스토어](https://experienceleague.adobe.com/docs/commerce-admin/b2b/introduction.html)의 사용자 지정 가격 책정 공유 카탈로그 및 AI 지원 검색을 위한 카탈로그 보강에 쉽게 액세스할 수 있습니다.
...
[카탈로그 보강](catalog-enrichment.md)을 사용하여 제품 이름과 긴 설명에 AI가 제안한 개선 사항을 검토하고 적용하여 카탈로그가 LLM 및 AI 지원 검색에서 정확하게 표시되도록 하십시오.
