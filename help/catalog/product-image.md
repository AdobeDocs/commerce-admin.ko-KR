...
**[!UICONTROL Store View]** 선택기를 **[!UICONTROL All Store Views]**&#x200B;이(가) 아닌 특정 저장소 보기로 전환하면 _[!UICONTROL Images and Videos]_섹션에서 기본 범위에 영향을 주지 않고 해당 저장소 보기에 대해 이미지가 표시되는 방식을 관리할 수 있는 추가 컨트롤을 제공합니다.

### 저장소 보기에 대한 이미지 순서 바꾸기

저장소 보기 범위에서 작업할 때 _[!UICONTROL Images and Videos]_상자 아래에&#x200B;**[!UICONTROL Use Default Order]**확인란이 표시됩니다. 이미지 표시 순서를 기본 범위에 정의된 시퀀스로 되돌리려면 이 확인란을 선택합니다.
