...
## 스토어 보기 수준에서 이미지 및 비디오 관리

**[!UICONTROL Store View]** 선택기를 **[!UICONTROL All Store Views]**&#x200B;이(가) 아닌 특정 저장소 보기로 전환하면 _[!UICONTROL Images and Videos]_&#x200B;섹션에서 기본 범위에 영향을 주지 않고 해당 저장소 보기에 대해 이미지가 표시되는 방식을 관리할 수 있는 추가 컨트롤을 제공합니다.

### 저장소 보기에 대한 이미지 순서 바꾸기

저장소 보기 범위에서 작업할 때 _[!UICONTROL Images and Videos]_&#x200B;상자 아래에&#x200B;**[!UICONTROL Use Default Order]**&#x200B;확인란이 표시됩니다. 이미지 표시 순서를 기본 범위에 정의된 시퀀스로 되돌리려면 이 확인란을 선택합니다.

![이미지 및 비디오 - 스토어 보기](./assets/product-images-and-videos-rearrange-store-scope.png){width="600" zoomable="yes"}

### 스토어 보기에 대한 이미지 세부 정보 설정

저장소 보기 범위에서 이미지 세부 사항 보기를 열면 **[!UICONTROL Alt Text]**, **[!UICONTROL Role]** 할당 이미지(기본, 작은, 썸네일, 견본) 및 **[!UICONTROL Hide from Product Page]**&#x200B;을(를) 포함한 각 필드에 **[!UICONTROL Use Default Value]** 확인란이 표시됩니다. 이 확인란을 선택하면 해당 필드의 기본 범위에 구성된 값을 상속할 수 있습니다.

![이미지 세부 사항 보기 - 스토어 보기](./assets/product-image-detail-store-scope.png){width="600" zoomable="yes"}
...
나만의 독창적인 상품 이미지를 만드는 데 드는 비용까지 생각하면 파렴치한 경쟁사들이 마우스 클릭으로 훔치는 것을 막기 위해 할 수 있는 일은 별로 없다. 그러나 각 이미지에 워터마크를 배치하여 속성을 식별함으로써 덜 매력적인 타겟으로 만들 수 있습니다. 워터마크 파일은 JPG(JPEG), GIF 또는 PNG 이미지일 수 있습니다. GIF 및 PNG 파일 유형은 모두 투명한 레이어를 지원하며, 이 레이어를 사용하여 워터마크에 투명한 배경을 지정할 수 있습니다.
