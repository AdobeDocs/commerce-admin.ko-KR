...
확장 설치 프로세스에 대한 자세한 내용은 [_설치 안내서_](https://experienceleague.adobe.com/ko/docs/commerce-operations/installation-guide/tutorials/extensions)를 참조하십시오.
...
>[!NOTE]
>
> 사용자가 제품에 3d 모델을 추가하는 일련의 데모 비디오를 보려면 _Commerce 비디오 및 자습서_&#x200B;의 [Adobe Commerce용 AR 뷰어](https://experienceleague.adobe.com/ko/docs/commerce-learn/tutorials/catalog/augmented-reality) 페이지를 참조하십시오.
