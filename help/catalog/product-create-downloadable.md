...
1. _[!UICONTROL Downloadable Product Options]_섹션에서 ![확장 선택기](../assets/icon-display-expand.png)를 확장합니다.
...
아래로 스크롤하여 _[!UICONTROL Downloadable Information]_섹션에서 ![확장 선택기](../assets/icon-display-expand.png)를 확장하고&#x200B;**[!UICONTROL Is this downloadable product?]**확인란을 선택합니다.
