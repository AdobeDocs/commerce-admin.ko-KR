...
>[!NOTE]
>
>시작 날짜 및 종료 날짜와 관련된 필드가에서 제거되었습니다. ![Adobe Commerce](../assets/adobe-logo.svg) Adobe Commerce에서 직접 수정할 수 없으며 장바구니 가격 규칙, 카탈로그 가격 규칙, 제품, 범주 및 CMS 페이지에서 바로 수정할 수 없습니다. 이러한 활성화를 위해 예약된 업데이트를 만들어야 합니다.
