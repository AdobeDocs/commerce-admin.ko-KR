...
| [!UICONTROL Action] | 개별 레코드에 적용할 수 있는 작업은 다음과 같습니다. <br/>**[!UICONTROL Edit]**- 편집 모드로 페이지를 엽니다.<br/>**[!UICONTROL Delete]** - 페이지를 삭제합니다.<br/>**[!UICONTROL View]**- 페이지를 미리보기 모드로 표시합니다. |
...
| [!UICONTROL Meta Title] | 페이지의 Meta 제목 |
...
1. 선택한 검색 필터를 표시하려면 **[!UICONTROL Filters]** !([Funnel 아이콘](../assets/icon-filter-search.png)) 탭을 클릭합니다.
...
페이지 변경 사항 및 캠페인 편집에 대한 일정을 구성할 때는 다음 사항에 유의하십시오.
