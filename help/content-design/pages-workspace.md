...
1. 그리드에서 행을 클릭합니다.
   ...
   ![페이지 속성은 페이지 그리드에서 편집할 수 있습니다](./assets/page-grid-properties-update.png){width="600" zoomable="yes"}
...
| [!UICONTROL Action] | 개별 레코드에 적용할 수 있는 작업은 다음과 같습니다.<br/>**[!UICONTROL Edit]**- 페이지를 편집 모드로 엽니다.<br/>**[!UICONTROL Delete]** - 페이지를 삭제합니다.<br/>**[!UICONTROL View]**- 페이지를 미리보기 모드로 표시합니다. |
...
왼쪽 상단의 검색 상자 _[!UICONTROL Pages]_grid를 사용하여 키워드별로 특정 페이지를 찾을 수 있습니다. 고급 검색의 경우 다음을 수행할 수 있습니다. [필터](../getting-started/admin-grid-controls.md) 여러 매개 변수로 검색합니다.

### 키워드로 검색

1. 페이지 검색 상자에 검색어를 입력합니다.

1. 결과를 표시하려면 검색(![돋보기 아이콘](../assets/icon-magnify-search.png)) 아이콘.

   결과에는 키워드가 포함된 모든 페이지가 포함됩니다.

### 검색 결과 필터링

1. 필요한 경우 **[!UICONTROL Clear All]** 을 클릭하여 이전 검색 기준을 지웁니다.

1. 선택한 검색 필터를 표시하려면 **[!UICONTROL Filters]** !([단계 아이콘](../assets/icon-filter-search.png)) 탭을 클릭합니다.
...
사용 _[!UICONTROL Action]_맨 오른쪽에 있는 열을 사용하여 다음 작업을 개별 페이지에 적용합니다.

- [!UICONTROL Edit] - 페이지를 편집 모드로 엽니다.
- [!UICONTROL Delete] - 페이지를 삭제합니다(확인 필요).
- [!UICONTROL View] - 상점 첫 화면에서 바로 페이지 열기

![단일 페이지 작업](./assets/page-grid-actions.png){width="600" zoomable="yes"}

### 대량 작업

다음을 사용하여 선택한 여러 페이지에 동시에 다음 작업 적용 _[!UICONTROL Action]_왼쪽 상단 모서리의 선택기:

- [!UICONTROL Delete] - 페이지를 삭제합니다(확인 필요).
- [!UICONTROL Disable] - 상점 첫 화면의 페이지를 비활성화합니다.
- [!UICONTROL Enable] - 상점 첫 화면의 페이지를 활성화합니다.
...
오른쪽 위 모서리에서 _열_ (![열 아이콘](../assets/icon-columns.png)) 를 제어하고 다음을 수행합니다.
...
1. 다음을 클릭합니다. _보기_ (![눈 아이콘](../assets/icon-view-eye.png)) 컨트롤을 클릭한 다음 **[!UICONTROL Save View As]**.

1. 보기의 이름을 입력합니다.

1. 보기를 저장하려면 _화살표_ (![화살표 아이콘](../assets/icon-arrow-save.png)).

   이제 뷰 이름이 현재 뷰로 나타납니다.

### 보기 변경

다음을 클릭합니다. _보기_ (![눈 아이콘](../assets/icon-view-eye.png)) 를 제어하고 다음 중 하나를 수행합니다.

- 사용할 보기를 선택합니다.

- 편집( )을 클릭하여 보기 이름을 변경합니다.![연필 아이콘](../assets/icon-edit-pencil.png)) 아이콘을 클릭하고 이름을 업데이트합니다.

  ![저장된 보기는 편집 아이콘으로 보기 컨트롤에 나타납니다](./assets/pages-default-grid-control.png){width="600" zoomable="yes"}
...
![홈 페이지에는 예약된 변경 사항이 맨 위에 표시됩니다](./assets/page-scheduled-change.png){width="600" zoomable="yes"}
...
또한 제품 업데이트에 대한 변경 사항을 예약하고 미리 볼 수 있습니다. 자세한 내용은 [업데이트 예약](content-staging-scheduled-update.md).
