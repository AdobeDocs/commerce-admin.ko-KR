...
스토어에서 사용할 수 있는 수많은 미디어 자산에 액세스하려면 [Adobe Stock](https://stock.adobe.com)을(를) [!UICONTROL Commerce]과(와) 통합하십시오.
...
- [Adobe Developer](https://developer.adobe.com/console/home) 계정
