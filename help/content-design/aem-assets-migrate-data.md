...
| **메타데이터 준비** | <ul><li><a href="/help/content-design/aem-assets-configure-aem.md">Commerce 자산에 대해 구성된 AEM Assets 메타데이터 프로필</a></li><li>각 자산에 대해 매핑된 메타데이터 값</li><li>CSV 파일 편집기(예: Microsoft Excel)</li></ul> |
