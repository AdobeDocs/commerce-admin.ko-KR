...
| 개인화된 오퍼 및 프로모션 | [장바구니 가격 규칙](https://experienceleague.adobe.com/en/docs/commerce-admin/marketing/promotions/cart-rules/price-rules-cart): Adobe [!DNL Commerce]의 고객 세그먼트를 포함한 일련의 조건을 기준으로 장바구니 항목에 할인을 적용합니다. |
