...
- Adobe [에서 장바구니 가격 규칙을 알리기 위해 &#x200B;](https://experienceleague.adobe.com/ko/docs/commerce/data-connection/use-cases/create-audience)Real-Time CDP에서 대상을 만들기[!DNL Commerce]하는 방법을 알아봅니다.
