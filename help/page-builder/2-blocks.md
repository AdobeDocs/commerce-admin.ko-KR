...
1. API 자격 증명을 구성하려면 [!DNL Google Maps] 설명서의 [지침][1]을(를) 따르십시오.
...
1. 그리드에서 첫 번째 자습서에서 만든 _[!UICONTROL Simple Page]_을(를) 찾은 다음_[!UICONTROL Action]_ 열에서 **[!UICONTROL Edit]**&#x200B;을(를) 선택합니다.
...
1. _[!UICONTROL Layout]_아래의 [!DNL Page Builder] 패널에서&#x200B;**[!UICONTROL Row]**자리 표시자를 스테이지의 맨 위로 드래그합니다.
...
1. **[!UICONTROL Select from Gallery]**&#x200B;을(를) 클릭하고 첫 번째 자습서에서 업로드한 `wide-banner-background.png` 이미지를 선택하여 _[!UICONTROL Background]_섹션으로 스크롤하고&#x200B;**[!UICONTROL Background Image]**을(를) 설정합니다.
...
_[!UICONTROL Layout]_아래의 [!DNL Page Builder] 패널에서&#x200B;**[!UICONTROL Column]**자리 표시자를 행으로 드래그합니다.
...
1. _[!UICONTROL Layout]_아래의 [!DNL Page Builder] 패널에서 새&#x200B;**[!UICONTROL Row]**자리 표시자를 스테이지의 맨 위로 드래그합니다.
