...
[[!DNL Page Builder] 단계](workspace.md#stage)에서 WYSIWYG(&quot;What You See Is What You Get&quot;) 편집기가 있는 텍스트 컨테이너를 추가하려면 _Text_ 콘텐츠 형식을 사용하십시오. 또한 편집기 도구 모음에서 텍스트에 링크, 이미지, [변수](../systems/variables-predefined.md) 및 위젯을 추가할 수 있습니다.
