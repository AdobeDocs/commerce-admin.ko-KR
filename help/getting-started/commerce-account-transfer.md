...
>[!NOTE]
>
>Adobe Commerce이 다른 Adobe 솔루션과 계속 통합됨에 따라 이제 Adobe Commerce 계정(MAGEID)에는 Adobe ID과의 연결이 필요합니다. Adobe ID은 [Adobe Commerce 계정](/help/getting-started/commerce-account-create.md#create-a-commerce-account)에 연결된 것과 동일한 전자 메일 주소를 사용합니다.
...
>
>- 현재 주인은 아직 회사에 있습니다.
>- 현재 소유자에게 Adobe ID이 없거나 [Adobe Commerce 계정(MAGEID)](/help/getting-started/commerce-account-create.md#create-a-commerce-account)에 연결되어 있지 않은 Adobe ID이 있습니다.
...
>
>- 현재 주인은 아직 회사에 있습니다.
>- 현재 소유자에게 [MAGEID(Adobe Commerce 계정)](/help/getting-started/commerce-account-create.md#create-a-commerce-account)에 연결된 Adobe ID이 있습니다.
...
1. 새 소유자로 [지원 요청을 제출](https://experienceleague.adobe.com/ko/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#support-case)합니다.
