...
적절한 권한이 있는 기본 계정 소유자만 공식적으로 공유 액세스 권한을 부여할 수 있습니다. 기본 계정 소유자가 더 이상 액세스할 수 없거나 회사를 떠난 경우 고객은 [Commerce 계정 전송 프로세스](https://experienceleague.adobe.com/en/docs/commerce-admin/start/commerce-account/commerce-account-transfer)를 사용하여 소유권을 새 연락처로 이동해야 합니다. Commerce 지원 팀은 제한된 시나리오에서 고객을 가장할 수 있지만 보안 및 책임 위험을 줄이려면 고객이 공유 액세스를 구성해야 합니다.
