...
[!DNL Commerce] 계정에는 신뢰할 수 있는 직원과 사이트 관리에 도움이 되는 서비스 공급자가 사용할 수 있는 정보가 포함되어 있습니다. 계정 액세스를 공유할 때 청구 기록 또는 신용카드 정보와 같은 모든 중요한 정보는 보호되며 다른 사용자에게는 제공되지 않습니다.

기본 계정 소유자는 다른 [!DNL Commerce] 계정 소유자에게 제한된 액세스 권한을 부여할 수 있습니다. 공유 액세스는 취소할 수 있지만 전송할 수는 없습니다. ``Cloud Shared Access from MAG[XYZ]`` 항목의 경우 **사용자 레코드를 여기에서 삭제할 수 없습니다**. 그러나 **액세스는 해지할 수 있습니다**.

적절한 권한이 있는 기본 계정 소유자만 공식적으로 공유 액세스 권한을 부여할 수 있습니다. 기본 계정 소유자가 더 이상 액세스할 수 없거나 회사를 떠난 경우 고객은 [Commerce 계정 전송 프로세스](/help/getting-started/commerce-account-transfer.md)를 사용하여 소유권을 새 연락처로 이동해야 합니다. Commerce 지원 팀은 제한된 시나리오에서 고객을 가장할 수 있지만 보안 및 책임 위험을 줄이려면 고객이 공유 액세스를 구성해야 합니다.


![공유 액세스 설정](./assets/shared-access.png){width="600" zoomable="yes"}

청구 내역 섹션에는 청구 시스템을 변경하기 전에 생성된 이전 송장만 표시됩니다. 새 송장이 표시되지 않으면 해당 송장이 새 시스템으로 전환되어 이 보기에서 액세스할 수 없습니다.
...
1. 공유 계정을 도움말 센터에 연결하려면 공유 계정의 왼쪽 탐색 패널에서 **[!UICONTROL Support]**&#x200B;을(를) 클릭합니다.
   ...
   >[!NOTE]
   >
   >공유 액세스 권한을 받은 후 Experience League에서 [지원 사례를 제출](https://experienceleague.adobe.com/ko/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#support-case)하려면 먼저 왼쪽 열에서 &quot;([!DNL Commerce])&quot;로 끝나는 조직 이름을 선택해야 합니다.
...
>[!NOTE]
>
>이 인터페이스에서 공유 이름이 _MAG에서 클라우드 공유 액세스[XYZ]_&#x200B;인 사용자를 삭제할 수 없습니다. [Cloud 프로젝트를 통해 공유 액세스 권한을 부여받은 사용자를 삭제하는 방법](https://experienceleague.adobe.com/ko/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#remove-cloud-shared-access-users)을 참조하세요.
