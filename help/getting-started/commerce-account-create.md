...
[첫 번째 지원 티켓을 제출](https://experienceleague.adobe.com/ko/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#support-case)하거나 특정 상점 외부에서 Adobe Commerce 관계를 처리해야 하는 경우 [!DNL Commerce] 계정을 만들거나 액세스해 보세요.
