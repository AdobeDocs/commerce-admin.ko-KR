...
[CCPA(캘리포니아 소비자 개인 정보 보호법][5])는 개인 정보를 수집, 저장 및 사용하는 방법을 결정하기 위해 캘리포니아 소비자의 권리를 확장합니다. 무허가 판매·교환 또는 소비자의 개인 정보로부터의 보호를 강조하고 있다. CCPA는 2018년에 제정되어 2020년 1월 1일부터 시행되었습니다.
...
- **클라우드 인프라의 Adobe Commerce**: Adobe [클라우드 인프라][4]{:target=&quot;_blank&quot;}에서 호스팅된 스토어를 사용하는 판매자는 Adobe Commerce 기술 계정 관리자 또는 고객 지원 팀에 소비자 요청에 대한 도움을 요청할 수 있습니다.
...
- **동의 연령**: 미성년자에 대한 개인 정보를 수집하거나 사용하는 경우 다음 요구 사항이 적용될 수 있습니다.
   ...
   - **미성년자 13~16**: 기업이 해당 조치를 문서화하는 합리적인 절차를 확립하는 경우 만 13세 이상 16세 미만의 미성년자는 개인 정보 판매를 선택할 수 있습니다. 프로세스는 회사의 [개인정보 처리방침](privacy-policy.md)에 설명되어야 합니다. 사업자가 이 연령대의 미성년자로부터 요구를 받으면 나중에 퇴출할 수 있는 권리를 알리고, 그 방법을 설명해야 한다.
...
[1]: https://experienceleague.adobe.com/docs/commerce-operations/security-and-compliance/reference/data-m2.html?lang=ko
[2]: https://experienceleague.adobe.com/docs/commerce-operations/security-and-compliance/reference/data-m1.html?lang=ko
