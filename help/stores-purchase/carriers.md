...
2026년 1월 25일부터 USPS는 기존 Web Tools API를 폐기했습니다. 이 날짜 이후에 Web Tools API에 대한 모든 요청이 실패합니다.

USPS 배송 서비스가 중단되지 않도록 하려면 최신 버전의 Adobe Commerce으로 업그레이드하거나 다음 작업을 수행하십시오.
