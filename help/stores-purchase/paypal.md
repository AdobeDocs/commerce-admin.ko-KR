...
>
>**PSD2 요구 사항:** <br/>
>2019년 9월 14일부터 유럽 은행은 [PSD2](../getting-started/compliance-payment-services-directive.md) 요구 사항을 충족하지 않는 결제를 거절할 수 있습니다. 대부분의 PayPal 솔루션에서는 PayPal에서 이러한 요구 사항을 처리하기 때문에 PSD2를 준수하는 데 필요한 작업이 필요하지 않습니다.
