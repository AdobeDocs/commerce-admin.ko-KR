...
- **FedEx** - 계정의 레이블 인쇄 요구 사항에 대해 알아보려면 [FedEx Web Integration Services](https://www.fedex.com/en-us/api/get-support.html)에 문의하십시오.
- **USPS** - Shiper 지원 센터의 [Web Tools API 포털](https://www.usps.com/business/web-tools-apis/#ssc)을 참조하여 레이블 인쇄 자격 증명을 설정하는 방법에 대해 알아보십시오.
- **UPS**- [UPS](https://www.ups.com/us/en/support/contact-us.page)에 문의하여 계정의 배송 레이블을 지원하는지 확인하십시오. 배송 레이블을 생성하려면 UPS XML 옵션을 사용해야 합니다.
- **DHL** - 계정의 레이블 인쇄 요구 사항에 대해 알아보려면 [DHL 전자 상거래 솔루션](https://www.dhl.com/us-en/home/our-divisions/ecommerce-solutions.html)에 문의하십시오.
...
1. **[!UICONTROL Origin]** 섹션에서 ![확장 선택기](../assets/icon-display-expand.png)을(를) 확장하고 **[!UICONTROL Shipping Origin Address]**&#x200B;을(를) 구성합니다.
...
1. **[!UICONTROL Delivery Methods]** 구성을 계속 진행하여 **[!UICONTROL USPS]** 섹션에서 ![확장 선택기](../assets/icon-display-expand.png)를 확장합니다.
...
1. **[!UICONTROL Delivery Methods]** 구성을 계속 진행하여 **[!UICONTROL FedEx]** 섹션에서 ![확장 선택기](../assets/icon-display-expand.png)를 확장합니다.
...
1. **[!UICONTROL Delivery Methods]** 구성을 계속 진행하여 **[!UICONTROL DHL]** 섹션에서 ![확장 선택기](../assets/icon-display-expand.png)를 확장합니다.

1. **[!UICONTROL DHL Type]**&#x200B;을(를) `DHL REST` 또는 `DHL XML`(으)로 선택합니다.

1. **[!UICONTROL DHL Type]** 선택을 기준으로 다음 자격 증명이 완료되었는지 확인합니다.
...
| [!UICONTROL Length, Width, Height] | (선택 사항) 패키지 차원은 사용자 지정 패키지에만 사용됩니다. 측정 단위를 인치 또는 센티미터로 지정할 수 있습니다.<br/><br/>**[!UICONTROL Not Required]**: 배달 확인이 배송 회사가 상점으로 전송되지 않습니다.<br/><br/>**[!UICONTROL No Signature]**: 받는 사람의 서명이 없는 배달 확인이 배송 회사가 상점으로 전송됩니다.<br/><br/>**[!UICONTROL Signature Required]**: 배송 회사가 받는 사람의 서명을 받고 상점에 인쇄된 사본을 제공합니다.<br/><br/>**[!UICONTROL Direct]**: (FedEx 전용) FedEx는 배달 주소에서 다른 사람의 서명을 받습니다. 패키지를 서명할 수 있는 사람이 없으면 통신사는 다른 시간에 패키지를 배달하려고 시도합니다.<br/><br/>**[!UICONTROL Indirect]**: (FedEx 주거용 배달만 해당) FedEx는 배달 주소에서 누군가(가능한 이웃 또는 건물 관리자)의 서명을 받습니다. 받는 사람은 서명된 FedEx 문 태그를 남겨 아무도 서명하지 않고 패키지를 남길 수 있도록 승인할 수 있습니다.<br/><br/>**[!UICONTROL Contents]**: (USPS만 해당) 다음 패키지 설명 중 하나를 선택하십시오.<br/>- 선물<br/>- 문서<br/>- 상업용 샘플<br/>- 반품 상품<br/>- 상품<br/>- 기타&#x200B;<br/><br/>**[!UICONTROL Explanation]**: (USPS만 해당) 패키지 내용에 대한 자세한 설명.<br/><br/>**[!UICONTROL Adult Required]**: 배송 업체는 성인 받는 사람의 서명을 받고 상점에 인쇄된 복사본을 제공합니다. |
...
| [!UICONTROL Signature] | 게재 확인을 정의합니다. 옵션:<br/><br/>**[!UICONTROL Not Required]**: 사용자에게 배달 확인 편지를 보내지 않습니다.<br/><br/>**[!UICONTROL No Signature]**: 받는 사람의 서명이 없는 배달 확인 편지를 보냅니다.<br/><br/>**[!UICONTROL Signature Required]**: 배송 회사가 받는 사람의 서명을 받고 인쇄된 복사본을 제공합니다.<br/><br/>**[!UICONTROL Adult Required]**: 배송 회사가 받는 사람의 서명을 받고 인쇄된 복사본을 제공합니다.<br/><br/>**[!UICONTROL Direct (FedEx only)]**: 배달 주소에서 받는 사람의 서명을 받고 패키지에 서명할 수 있는 사람이 없는 경우 배달을 다시 시도합니다.<br/><br/>**[!UICONTROL Indirect (FedEx only)]**: 배달 주소에서 받는 사람의 서명을 받습니다.<br/>(1); 주소의 이웃, 건물 관리자 또는 다른 사람으로부터 <br/>(2); 또는 <br/>(3) 받는 사람이 서명된 FedEx Door Plug Release를 승인하는 패키지 없이 보낼 수 있습니다. 가정용 게재에만 사용할 수 있습니다. 배송 방법마다 옵션이 조금씩 다를 수 있습니다. 최신 정보는 운송 회사의 리소스를 참조하십시오. |
