...
| [!UICONTROL Select] | 속성을 드롭다운 목록으로 표시합니다. **[!UICONTROL Add New Option]**&#x200B;을(를) 클릭하여 드롭다운 목록에 조건을 더 추가합니다.<br/>**[!UICONTROL Code]**- 내부적으로 특성을 식별하는 고유한 이름입니다.<br/>**[!UICONTROL Label]** - 고객 계정 대시보드에서 특성을 식별하는 이름입니다.<br/>**[!UICONTROL Is Default]**- 이 스위치를 설정하여 기본 조건을 선택합니다.<br/>**[!UICONTROL Delete Option]** - 옵션을 삭제하려면 클릭하십시오. |
...
| [!UICONTROL Role] | 선물 받는 사람을 식별하는 역할입니다. 예: `Bride`, `Groom` 또는 `Partner`.<br/>**[!UICONTROL Is Searcheable]**- `Yes`/ `No`<br/>**&#x200B;나열됨&#x200B;**- `Yes`/ `No`<br/>**[!UICONTROL Add New Option]**(으)로 설정 - 드롭다운 메뉴에 조건을 추가하려면 클릭:<br/>**코드** - 특성을 내부적으로 식별하는 고유한 이름&#x200B;<br/>**[!UICONTROL Label]**- 고객 계정 대시보드에서 특성을 식별하는 이름입니다.<br/>**[!UICONTROL Is Default]** - 이 스위치를 설정하여 기본 조건을 선택합니다.<br/>**[!UICONTROL Delete Option]**- 옵션을 삭제하려면 클릭하십시오. |
