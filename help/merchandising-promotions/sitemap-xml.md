...
자세한 내용은 _Commerce on Cloud Infrastructure Guide_&#x200B;에서 [사이트 맵 및 robots.txt 추가](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure-store/robots-sitemap.html)를 참조하십시오.
...
>[!NOTE]
>
>큰 카탈로그가 있는 저장소의 경우 대체 cronjob을 사용하여 모든 데이터가 생성되도록 할 수 있습니다. `app/code/Magento/Sitemap/etc/config.xml`에서 바꾸기:
>
>```xml
><jobs>
>   <sitemap_generate>
...
>```
>
>이 변경 사항을 사용하면 큰 카탈로그에 권장되는 일괄 사이트 맵 생성을 사용할 수 있습니다.
