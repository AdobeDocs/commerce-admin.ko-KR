...
이 안내서는 Adobe Commerce 또는 Magento Open Source 관리자에서 일하는 판매자 및 시스템 관리자를 위한 것입니다. _>_ > **[!UICONTROL Stores]**&#x200B;의 _[!UICONTROL Settings]_관리자&#x200B;**[!UICONTROL Configuration]**사이드바에서 액세스하는 모든 저장소 구성 설정에 대한 참조 정보를 제공합니다.
