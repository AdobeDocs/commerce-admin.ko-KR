...
![결제 서비스 설정](assets/payment-services-menu-small.png){zoomable: no, width: 400px}
...
![일반 설정](assets/payments-general-settings.png){zoomable: yes, width: 600px}
...
![신용 카드 필드 설정](assets/payments-ccfields-settings.png){zoomable: yes, width: 600px}
...
| [!UICONTROL Show vaulted payment methods in Admin] | 스토어 뷰 | 관리자가 판매자가 고객에 대한 주문을 완료할 수 있는 기능을 활성화 또는 비활성화합니다. [적립된 결제 방법 사용](https://experienceleague.adobe.com/docs/commerce-merchant-services/payment-services/payments-checkout/vaulting.html). 옵션: [!UICONTROL Yes] / [!UICONTROL No] |
...
![Paypal 결제 버튼 설정](assets/payments-ppbuttons-settings.png){zoomable: yes, width: 600px}
...
![Paypal 결제 버튼 스타일 설정](assets/payments-buttonstyle-settings.png){zoomable: yes, width: 600px}
