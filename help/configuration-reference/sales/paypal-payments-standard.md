...
| [!UICONTROL Home Page] | 웹 사이트 | 의 위치 및 크기를 결정합니다. [!DNL PayPal Credit] 홈 페이지의 배너. 옵션: <br/>**`Display`**- 다음 여부를 결정합니다. [!DNL PayPal Credit] 배너는 스토어의 홈 페이지에 표시됩니다. 옵션: `Yes` / `No`<br/>**`Position`** - 의 위치를 결정합니다 [!DNL PayPal Credit] 홈 페이지의 배너. 옵션: `Header (center)` / `Sidebar (right)` <br/>**`Size`**- 크기 결정 [!DNL PayPal Credit] 홈 페이지의 배너. 옵션: `190 x 100` / `234 x 60` / `300 x 50` / `468 x 60` / `728 x 90` /` 800 x 66` |
