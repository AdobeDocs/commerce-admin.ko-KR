...
description: Commerce 관리자의 [!UICONTROL Sales Channels] > [!UICONTROL Global Settings] 페이지에서 구성 설정을 검토합니다.
...
이러한 설정은 [[!DNL Amazon Sales Channel]](https://experienceleague.adobe.com/ko/docs/discontinued/using/commerce-channels)을(를) 설치할 때 사용할 수 있습니다.
