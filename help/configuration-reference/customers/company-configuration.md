...
![이메일 옵션 - 회사 등록](./assets/company-email-options-company-registration.png)<!-- zoom -->
...
![고객 관련 이메일](./assets/company-email-options-customer-related-emails.png)<!-- zoom -->
...
| [!UICONTROL Default "Company Status Change to Active 1' Email] | 스토어 뷰 | 회사의 상태가에서 변경될 때 사용되는 이메일 템플릿 _승인 보류 중_ 끝 _활성_. 기본 템플릿: `Company Status Active 1` |
| [!UICONTROL Default 'Company Status Change to Active 2' Email] | 스토어 뷰 | 회사의 상태가에서 변경될 때 기본적으로 사용되는 이메일 템플릿 _거부됨_ 또는 _차단됨_ 끝 _활성_. 기본 템플릿: `Company Status Active 2` |
| [!UICONTROL Default 'Company Status Change to Rejected' Email] | 스토어 뷰 | 회사 상태가 (으)로 변경될 때 기본적으로 사용되는 이메일 템플릿 _거부됨_. 기본 템플릿: `Company Status Rejected` |
...
![회사 신용](./assets/company-email-options-company-credit.png)<!-- zoom -->
...
| [!UICONTROL Reimbursed Email Template] | 스토어 뷰 | 다음의 경우에 기본적으로 사용되는 이메일 템플릿 [환급](../../b2b/credit-company.md#apply-a-payment-to-a-company-account) 이(가) 회사의 신용에 대해 계산됩니다. 이 이메일은 회사 관리자에게 전송됩니다. 기본 템플릿: `Credit Reimbursed` |
