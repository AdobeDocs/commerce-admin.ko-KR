...
견적이 활성화된 경우 고객 계정 대시보드의 _[!UICONTROL My Quotes Template]_&#x200B;섹션에 고객 계정과 연결된 모든 견적 템플릿이 나열됩니다. 권한에 따라, 회사를 대신하여 구매하는 구매자만 견적 템플릿을 요청하고 반복 주문에 대한 견적 가격 및 조건을 협상할 수 있습니다.
...
견적 템플릿이 취소되어 견적 상태가 `Closed`(으)로 변경됩니다. 닫힌 따옴표는 *[!UICONTROL Inactive]*&#x200B;개의 따옴표 목록에 남아 있으며, 관리자의 _[!UICONTROL Quote Templates]_&#x200B;표에 남아 있습니다.

## 참조 문서 링크 관리

참조 문서 링크 기능을 사용하면 견적 템플릿 프로세스 중에 구매자와 판매자가 외부 문서(예: 계약, 계약 또는 사양)에 대한 링크를 추가, 편집 및 관리할 수 있습니다.

### 참조 문서 링크 추가

1. 견적 템플리트를 엽니다.

1. **[!UICONTROL Reference Documents]** 섹션에서 **[!UICONTROL Add]**&#x200B;을(를) 클릭합니다.
...
1. **[!UICONTROL Reference Documents]** 섹션에서 삭제할 문서 링크 옆에 있는 **[!UICONTROL Remove]**&#x200B;을(를) 클릭합니다.

### 참조 문서 보기

1. 견적 템플리트를 엽니다.

1. **[!UICONTROL Reference Documents]** 섹션에서 문서 이름 링크를 클릭합니다.

   문서가 새 브라우저 창에서 열립니다.

### 참조 문서 링크 제한 사항

- 참조 문서 링크는 견적 템플릿이 편집 가능한 상태일 때만 추가, 편집 또는 제거할 수 있습니다.
