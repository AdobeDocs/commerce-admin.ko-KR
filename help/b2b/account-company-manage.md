---
title: 회사 계정 관리
description: Adobe Commerce 스토어의 회사 계정을 관리하는 데 도움이 되는 회사 페이지 및 그리드에서 사용할 수 있는 도구에 대해 알아봅니다.
...
사용 _[!UICONTROL Search]_에서 회사를 찾는 기능&#x200B;**회사**키워드별 그리드입니다. 에서 지정된 키워드를 검색하여 회사를 찾습니다.**회사 이름**및&#x200B;**상위**열. 다음을 기준으로 필터링할 수 있습니다.**회사 유형**모회사 및 관련 회사를 표시하거나 하위 회사만 표시합니다.
...
1. 설정 **[!UICONTROL Actions]** 제어 대상 `Set Active`.
...
1. 설정 [!UICONTROL **작업**] 다음 중 하나를 제어하십시오.
...
1. 다음에서 _작업_ 맨 오른쪽에 있는 열을 클릭합니다. [!UICONTROL **편집**].
...
1. 설정 **[!UICONTROL Actions]** 제어 대상 `Block`.
...
1. 설정 **[!UICONTROL Actions]** 제어 대상 `Convert Currency`.
...
| [!UICONTROL Reason for Change] | 회사가 크레딧 한도를 초과하도록 허용되거나 허용하지 않는 이유를 설명하는 참고 사항. 이 필드는 크레딧 제한 초과 권한이 변경된 경우에만 활성화됩니다. |
