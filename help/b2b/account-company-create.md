...
1. 정보가 완료되면 다음을 선택합니다. **[!UICONTROL Submit]**.
...
![책임자로부터 새 회사 추가](./assets/company-add-new.png){width="700" zoomable="yes"}
...
1. 완료되면 다음을 선택합니다. **[!UICONTROL Save]**.
...
| [!UICONTROL Group/Shared Catalog] | (관리자만) 다음을 나타냅니다. [고객 그룹](../customers/customer-groups.md) 또는 [공유된 카탈로그](catalog-shared.md) 회사에 할당되었습니다. |
