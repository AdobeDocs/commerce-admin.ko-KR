...
![페이지 매김이 있는 요청 목록](./assets/requisition-list-bottom-with-pagination.png){width="700" zoomable="yes"}

>[!NOTE]
>
> 주의가 필요한 제품(예: 품절 제품)이 페이지 매김 의 현재 페이지에 속하는 경우 목록 맨 위에 표시됩니다. 주의가 필요한 제품 수가 목록 위에 표시됩니다.
> ![주의가 필요한 항목](./assets/requisition-list-product-requiring-attention.png){width="500"}

### Storefront 페이지 매김 컨트롤

| 제어 | 설명 |
|----------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![페이지당 표시](./assets/control-pagination-show-per-page.png) | [!UICONTROL Show Per Page] - 페이지당 표시되는 구매요청 목록 항목의 수를 결정합니다. 페이지에 표시할 20, 50, 100, 500 또는 1000 구매요청 목록 품목을 선택할 수 있습니다. |
| ![페이지 매김 링크](./assets/control-pagination.png) | [!UICONTROL Pagination links] - 다른 페이지로 연결되는 탐색 링크를 제공합니다. |